...
<html>
	<head>
		...
		<%
			LinkedList<Position> pl = (LinkedList<Position>) request.getAttribute("positionsList");
			boolean emptyList = (pl == null || pl.isEmpty());
		%>
		...
		<div class="container" style="color: white;">
			<div class="row">
				<div class="d-flex justify-content-between my-4 align-items-center">
	        		<h1>Posiciones</h1>
		        	<form action="actionposition" method="get" style="margin:0;">
				...
				<% if (emptyList) { %>
					<div class="d-flex justify-content-center align-items-center" style="min-height: 60vh;">
						<div class="col-12">
						    ...
						    <h3 class="fw-bold mb-2">Todavía no agregaste posiciones</h3>
						    	<p class="mb-0" style="opacity:.85;">
						        	No hay posiciones registradas. Usá el botón de <strong>(+)</strong> cuando quieras agregar la primera.
						      	</p>
					    	</div>
					  	</div>
					</div>
	                    	...
	                    	<table class="table table-dark mb-0">
	                    		...
	                    		%>
	                    			<tr>
	                    				...
	                    				<td>
	                    					<form method="get" action="actionposition" style="display:inline;" class="d-flex justify-content-center align-items-center">
	                    				...
	                    				<td>
	                    					<form method="post" action="actionposition" style="display:inline;" class="d-flex justify-content-center align-items-center">
												<input type="hidden" name="action" value="delete" />
												<input type="hidden" name="id" value="<%=p.getId()%>" />
												<button type="button" style="background-color: #9B1C1C" class="btn btn-sm btn-open-modal" data-action="delete" data-id="<%= p.getId() %>" >
			...
			document.addEventListener("DOMContentLoaded", function() {
			    ...
			    document.querySelectorAll('.btn-open-modal').forEach(button => {
			        button.addEventListener('click', function() {
			            ...
			            modalBody.textContent = "¿Estás seguro que querés eliminar esta posición?";
