...
<html>
	<head>
		...
		<%
			LinkedList<Nationality> nl = (LinkedList<Nationality>) request.getAttribute("nationalitiesList");
			boolean emptyList = (nl == null || nl.isEmpty());
		%>
		...
		<div class="container" style="color: white;">
			<div class="row">
				<div class="d-flex justify-content-between my-4 align-items-center">
		        	...
		        	<form action="actionnationality" method="get" style="margin:0;">
				...
				<% if (emptyList) { %>
					<div class="d-flex justify-content-center align-items-center" style="min-height: 60vh;">
						<div class="col-12">
						    ...
						    <h3 class="fw-bold mb-2">Todavía no agregaste nacionalidades</h3>
						    	<p class="mb-0" style="opacity:.85;">
						        	No hay nacionalidades registradas. Usá el botón de <strong>(+)</strong> cuando quieras agregar la primera.
						      	</p>
					    	</div>
					  	</div>
					</div>
	            	...
	            	<div class="col-12 col-sm-12 col-lg-12">
	                	<div class="table-responsive rounded-3 border overflow-hidden mb-5">
	                    	<table class="table table-dark mb-0">
	                    		...
	                    		<tbody>
	                    		<%
	                    	    	for (Nationality n : nl) {
	                    		%>
	                    			<tr>
	                    				<td>
											<img alt="" src="<%=request.getContextPath() + "/images?id=" + n.getFlagImage()%>" height="30" width="50">
										</td>
	                    				<td><b><%=n.getName()%></b></td>
	                    				<td><%=n.getIsoCode()%></td>
	                    				<td><%=n.getContinent().getDisplayName()%></td>
	                    				<td>
	                    					<form method="get" action="actionnationality" style="display:inline;" class="d-flex justify-content-center align-items-center">
	                    				...
	                    				<td>
	                    					<form method="post" action="actionnationality" style="display:inline;" class="d-flex justify-content-center align-items-center">
												<input type="hidden" name="action" value="delete" />
												<input type="hidden" name="id" value="<%=n.getId()%>" />
												<button type="button" style="background-color: #9B1C1C" class="btn btn-sm btn-open-modal" data-action="delete" data-id="<%= n.getId() %>" >
			...
			document.addEventListener("DOMContentLoaded", function() {
			    ...
			    document.querySelectorAll('.btn-open-modal').forEach(button => {
			        button.addEventListener('click', function() {
			            ...
			            modalBody.textContent = "¿Estás seguro que querés eliminar esta nacionalidad?";
