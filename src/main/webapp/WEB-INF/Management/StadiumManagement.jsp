...
<html>
	<head>
		...
		<%
			...
			boolean emptyList = (sl == null || sl.isEmpty());
		%>
				...
				<% if (emptyList) { %>
					<div class="d-flex justify-content-center align-items-center" style="min-height: 60vh;">
						<div class="col-12">
						    ...
						    <h3 class="fw-bold mb-2">Todavía no agregaste estadios</h3>
						    	<p class="mb-0" style="opacity:.85;">
						        	No hay estadios registrados. Usá el botón de <strong>(+)</strong> cuando quieras agregar el primero.
						      	</p>
					    	</div>
					  	</div>
					</div>
